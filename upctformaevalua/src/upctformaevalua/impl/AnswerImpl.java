 ...
 * </p>
 * <ul>
 *   <li>{@link upctformaevalua.impl.AnswerImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnswerImpl extends MinimalEObjectImpl.Container implements Answer {
	...
	protected EClass eStaticClass() {
		return UpctformaevaluaPackage.Literals.ANSWER;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UpctformaevaluaPackage.ANSWER__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UpctformaevaluaPackage.ANSWER__TEXT:
				return getText();
		}
